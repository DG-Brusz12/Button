...
banner="""\033[94m
  ────────────────────────────────
   ...
   |   Youtube \033[91m: \033[90mDanszzGamimg   \033[97m|
   |   Creator \033[91m: \033[90mDG_Brusz12     \033[97m|
  \033[94m────────────────────────────────"""
...
#____Extra Button
Key1 = "extra-keys = [['nano','pkg','-y','TAB','*','_','ESC','ALT','UP','END'],['cd','python2','ls','HOME','-','/','CTRL','LEFT','DOWN','RIGHT']]"
...
#____Open Youtube
def yt():
    os.system("xdg-open https://youtube.com/channel/UCLVL7gLh5LxflU96WHGKVgg")
...
#############################
##                         ##
## Youtube _ DanszzGaming  ##
## Creator _ DG_Brusz12    ##
##                         ##
#############################
